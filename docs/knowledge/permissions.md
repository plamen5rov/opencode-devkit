...
You can override permissions per agent. Agent permissions are merged with the global config, and agent rules take precedence. [Learn more](about:/docs/agents#permissions) about agent permissions.
