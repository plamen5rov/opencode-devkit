...
Set `attention.enabled` to turn on TUI desktop notifications and sounds. See [TUI attention](about:/docs/tui#attention).
...
You can also configure [local models](about:/docs/models#local). [Learn more](https://opencode.ai/docs/models).
...
[Learn more about Amazon Bedrock configuration](about:/docs/providers#amazon-bedrock).
