...
Your local config values override the remote defaults. See [config precedence](about:/docs/config#precedence-order) for more details.
...
* Option: type
  * Type: String
  * Required: Y
  * Description: Type of MCP server connection, must be "local".
* Option: command
  * Type: Array
  * Required: Y
...
* Option: timeout
  * Type: Number
  * Required: 
  * Description: Timeout in ms for fetching tools from the MCP server. Defaults to 5000 (5 seconds).
...
* Option: type
  * Type: String
  * Required: Y
  * Description: Type of MCP server connection, must be "remote".
* Option: url
  * Type: String
  * Required: Y
...
* Option: oauth
  * Type: Object
  * Required: 
  * Description: OAuth authentication configuration. See OAuth section below.
* Option: timeout
  * Type: Number
  * Required: 
  * Description: Timeout in ms for fetching tools from the MCP server. Defaults to 5000 (5 seconds).
...
* Option: oauth
  * Type: Object | false
  * Description: OAuth config object, or false to disable OAuth auto-detection.
* Option: clientId
  * Type: String
...
2.  In your [agent config](about:/docs/agents#tools), enable the MCP server as a tool.
